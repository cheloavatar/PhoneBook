<nav x-data="{ open: false }" class="bg-stone border-b border-stone-100 shadow">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('agenda.index') }}" :active="request()->routeIs('agenda.index')">
                        {{ __("PERSONS")}}
                    </x-jet-nav-link>
                ...
                <div class="ml-3 relative">
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-stone-500 bg-stone hover:text-stone-700 focus:outline-none transition">
                                        {{ Auth::user()->name }}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('agenda.index') }}" :active="request()->routeIs('agenda.index')">
                PERSONS
            </x-jet-responsive-nav-link>
